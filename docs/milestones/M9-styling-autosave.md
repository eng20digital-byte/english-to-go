...
3. Make a change, immediately navigate to a different page in the same booklet before the debounce fires — confirm the change still saved (navigate-away safety net).
